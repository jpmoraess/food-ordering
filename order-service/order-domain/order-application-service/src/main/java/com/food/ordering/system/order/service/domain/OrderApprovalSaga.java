...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
    ...
    public void rollback(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        approvalOutboxHelper.save(getUpdatedApprovalOutboxMessage(
                orderApprovalOutboxMessage, orderCancelledEvent.getOrder().getOrderStatus(), sagaStatus));
    ...
    private OrderApprovalOutboxMessage getUpdatedApprovalOutboxMessage(OrderApprovalOutboxMessage
        ...
        orderApprovalOutboxMessage.setProcessedAt(ZonedDateTime.now(ZoneId.from(UTC)));
