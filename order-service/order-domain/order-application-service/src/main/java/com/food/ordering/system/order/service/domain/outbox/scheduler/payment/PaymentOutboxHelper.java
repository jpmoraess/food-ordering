...
public class PaymentOutboxHelper {
    ...
    getPaymentOutboxMessageByOutboxStatusAndSagaStatus(OutboxStatus outboxStatus, SagaStatus... sagaStatus) {
    ...
    public void save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
        ...
        log.info("OrderPaymentOutboxMessage saved with outbox id: {}", response.getId().toString());
    }
